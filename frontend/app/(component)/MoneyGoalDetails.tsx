...
const MoneyGoalDetails = ({ goal, visible, mode, onClose, onSaved, t, onSubmit }: Props) => {
  ...
  const screenTitle = mode === "edit" ? t("update_goal") + " SAVEMONEY" : t("add_goal") + " SAVEMONEY";
...
export default MoneyGoalDetails;
