...
import { Modal, View, Text, StyleSheet, ScrollView, TouchableOpacity, Platform, Alert } from "react-native";
...
const NumberGoalDetails = ({ goal, visible, mode, onClose, onSaved, t, onSubmit }: Props) => {
  ...
  const [quantity, setQuantity] = useState(goal?.quantity?.toString() || "");
  ...
  const screenTitle = mode === "edit" ? t("update_goal") + " TODOQUANTITY" : t("add_goal") + " TODOQUANTITY";
...
export default NumberGoalDetails;
